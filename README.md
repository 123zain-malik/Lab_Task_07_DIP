...
2023-SE-02_Lab_Task_07_DIP

Write a Python program using NumPy, OpenCV, and Matplotlib, fully compatible with Google Colab, to demonstrate Frequency Domain Filtering on a grayscale image.
...
Effects of LPF vs HPF
Differences between Ideal, Butterworth, Gaussian filters
Comparison with spatial filtering
